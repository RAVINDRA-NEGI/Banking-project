package com.raz.accounts.controller;
...
import com.raz.accounts.dto.ErrorResponseDto;
import com.raz.accounts.dto.ResponseDto;
...
@Tag(
		...
		description = "CRUD REST API in Bank to CREATE , UPDATE , FETCH AND DELETE account details"
    )
@RestController
